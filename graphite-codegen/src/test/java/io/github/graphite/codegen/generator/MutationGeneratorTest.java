...
class MutationGeneratorTest {
  ...
  class GraphQLOperationMethods {
    ...
    void shouldGenerateOperationNameMethod() {
      ...
      assertThat(source)
          .contains("public String operationName()")
          .contains("return \"CreateUser\"");
    }
    ...
    void shouldGenerateToGraphQLMethodWithMutationKeyword() {
      ...
      assertThat(source)
          ...
          .contains("mutation CreateUser")
          .contains("$input: CreateUserInput!")
          .contains("createUser(input: $input)")
