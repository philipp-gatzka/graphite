 ...
 *
 * <p>This exception is thrown when the GraphQL server returns errors in the
 * response's {@code errors} field. Unlike HTTP-level errors, GraphQL errors
 * may be partial - the response may contain both data and errors.
 *
 * <p>The exception provides access to all errors returned by the server:
 * <ul>
 *   <li>{@link #getErrors()} - The list of all GraphQL errors</li>
 *   <li>{@link #getFirstError()} - Convenience method for the first error</li>
 *   <li>{@link #hasErrorWithCode(String)} - Check if a specific error code is present</li>
 * </ul>
 *
 * <p>Example usage:
 * <pre>{@code
...
public class GraphiteGraphQLException extends GraphiteServerException {
     ...
     *
     * <p>This is a convenience method for cases where only the first error
     * is needed.
     *
     ...
     *
     * <p>Error codes are typically found in the {@code extensions.code} field
     * of each error.
     *
