 ...
 *
 * <p>This exception is thrown when a configured timeout is exceeded. The
 * {@link #getTimeoutType()} method indicates which timeout was exceeded:
 * <ul>
 *   <li>{@link TimeoutType#CONNECT} - Connection establishment timeout</li>
 *   <li>{@link TimeoutType#READ} - Response read timeout</li>
 *   <li>{@link TimeoutType#REQUEST} - Overall request timeout</li>
 * </ul>
 *
 * <p>Timeout exceptions may be retryable depending on the timeout type and
 * operation idempotency. Connect timeouts are generally safe to retry, while
 * read and request timeouts may require verification of server state for
...
public class GraphiteTimeoutException extends GraphiteClientException {
     ...
     *
     * <p>This may be slightly different from the configured timeout due to
     * measurement granularity and system scheduling.
     *
     ...
     *
     * <p>Only {@link TimeoutType#CONNECT} timeouts are considered safe to retry,
     * as no request was sent to the server. Other timeout types may have resulted
