 ...
 * <ul>
 *   <li>{@code message} - A description of the error (required)</li>
 *   <li>{@code locations} - The locations in the GraphQL document where the error occurred</li>
 *   <li>{@code path} - The path to the field that caused the error</li>
 *   <li>{@code extensions} - Additional error metadata</li>
 * </ul>
 *
 ...
 * @param locations the locations in the GraphQL document where the error occurred,
 *                  may be {@code null} or empty
 * @param path the path to the response field that caused the error,
 *             may be {@code null} or empty
...
public record GraphQLError(
     ...
     *
     * <p>Many GraphQL servers include an error code in the extensions map
     * under the key "code".
     *
     ...
     *
     * <p>For example, the path {@code ["user", "posts", 0, "title"]} would
     * be formatted as {@code "user.posts.0.title"}.
     *
